...
node - Users
edges - friendships. bidirectional/undirected
connected components - users extended social network

bfs/t use? find the shortest path to someone in extended network
